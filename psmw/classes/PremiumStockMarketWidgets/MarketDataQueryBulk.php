                ...
                if (isset($responseResultObject->symbol)) {
                  ...
                  $this->data->$symbol->virtual->name =
                    ...
                    $this->env->companies->$symbol :
                      ...
                      $symbol);
                  $this->data->$symbol->virtual->symbolLink = isset($this->env->settings->linksOverrides->$symbol) ?
                    '<a href="'.$this->env->settings->linksOverrides->$symbol.'">'.$symbol.'</a>':
                    '<a href="'.str_replace(['{symbol}','{name}'],[$symbol,preg_replace('#[^a-z]#i','',$this->data->$symbol->virtual->name)], $this->env->settings->linkMask).'">'.$symbol.'</a>';
                  $this->data->$symbol->virtual->nameLink = isset($this->env->settings->linksOverrides->$symbol) ?
                    '<a href="'.$this->env->settings->linksOverrides->$symbol.'">'.$this->data->$symbol->virtual->name.'</a>':
                    '<a href="'.str_replace(['{symbol}','{name}'],[$symbol,preg_replace('#[^a-z]#i','',$this->data->$symbol->virtual->name)], $this->env->settings->linkMask).'">'.$this->data->$symbol->virtual->name.'</a>';
